...
int nTotalSockets = 0;
SOCKETINFO *SocketInfoArray[WSA_MAXIMUM_WAIT_EVETNS];
WSAEVENT EventArray[WSA_MAXIMUM_WAIT_EVETNS];
...
int main(int argc, char **argv)
{
	...
	// 데이터 통신에 사용할 변수
	WSANETWORDEVENTS NetworkEvents;
	SOCKET client_sock;
